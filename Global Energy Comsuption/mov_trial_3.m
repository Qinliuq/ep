...
axis([0,1,0,1]);
axis square;
timer=text(0.8,0.15,num2str(year));
...
y4=x4+(1-x4).*log(1-x4);
year=1990+j;
plot(cm_popratio,cm_ecratio,'r*-',cm_popratio90,cm_ecratio90,'m*-',cm_popratio80,cm_ecratio80,'b*-',x4,y4,'k.');
axis([0,1,0,1]);
axis square;
timer=text(0.8,0.15,num2str(year));
set(timer,'Fontsize',20,'Fontweight','Bold');
...
y4=x4+(1-x4).*log(1-x4);
year=2000+j;
plot(cm_popratio,cm_ecratio,'r*-',cm_popratio00,cm_ecratio00,'k*-',cm_popratio90,cm_ecratio90,'m*-',cm_popratio80,cm_ecratio80,'b*-',x4,y4,'k.');
axis([0,1,0,1]);
axis square;
timer=text(0.8,0.15,num2str(year));
set(timer,'Fontsize',20,'Fontweight','Bold');
